...
public class Ball {
	...
	*/
	...
	public Ball(double cx, double cy, double width, double height, Color color, double speed){
		...
		this.direcaoX = this.rndDirection();
		this.direcaoY = this.rndDirection();
	}
	...
	*/	
	...
	public boolean checkCollision(Player player){
		...
		boolean ballBetweenPlayerAndBottom = ballBottom >= playerTop && ballTop <= playerBottom;

		return rightColision && leftColision && ballBetweenPlayerAndBottom;
	}
